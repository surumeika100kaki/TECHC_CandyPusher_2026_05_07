...
public class CreateCandy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        void Update()
    {
        float z = Mathf.Sin(Time.time * speed) * CreateCandy_MoveRange_x;
        float x = Mathf.Sin(Time.time * speed) * CreateCandy_MoveRange_z;
        //this.transform.position = stastartPosition + new Vector3(x, 0, 0);
